...
flecs::entity EntityManager::CreateMeshEntity(const std::string &mesh_name)
{
	flecs::entity newEntity = m_pEcs->entity();
	uint32_t nIndex = GetNewIndex();

	RenderNode* pRenderNode = new RenderNode(nIndex, Ogre::String(mesh_name));
