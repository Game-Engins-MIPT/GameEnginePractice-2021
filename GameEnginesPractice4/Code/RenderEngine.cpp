...
Ogre::SceneNode* RenderEngine::RT_CreateSceneNode(const Ogre::String &mesh_name)
{
	...
	Ogre::Item* item = m_pSceneManager->createItem(mesh_name,
...
void RenderEngine::RT_SceneNodeSetPosition(Ogre::SceneNode* node, const Ogre::Vector3 &pos)
{
